...
export const BUDGETS: BudgetRange[] = [
  ...
  { id: "40plus", label: "40rb ke atas", min: 40000, max: Infinity, emoji: "🤑", hint: "Bebas, lagi gajian" },
];
...
/** "Situasi kamu hari ini?" */
export const CONTEXTS: ContextOption[] = [
  { id: "hujan", label: "Lagi Hujan", emoji: "🌧️" },
  { id: "capek", label: "Lagi Capek", emoji: "😵" },
  { id: "deadline", label: "Lagi Deadline", emoji: "💻" },
  { id: "akhirbulan", label: "Akhir Bulan", emoji: "💸" },
  { id: "gajian", label: "Baru Gajian", emoji: "🎉" },
  { id: "sakit", label: "Kurang Enak Badan", emoji: "🤒" },
  { id: "selfreward", label: "Self Reward", emoji: "❤️" },
  { id: "nongkrong", label: "Mau Nongkrong", emoji: "🎬" },
  { id: "rumah", label: "Di Rumah Aja", emoji: "🏠" },
  { id: "jalan", label: "Lagi di Jalan", emoji: "🚶" },
];
...
/** Soft caps so "40rb+" doesn't return a feast every time. */
...
/** Manual fallback locations when geolocation is denied. Coords are area centroids. */
export const MANUAL_LOCATIONS: ManualLocation[] = [
  ...
  { id: "jaktim", label: "Jakarta Timur", lat: -6.2250, lng: 106.9004 },
  ...
  { id: "tangerang", label: "Tangerang", lat: -6.1781, lng: 106.6300 },
  { id: "bsd", label: "BSD / Serpong", lat: -6.3019, lng: 106.6527 },
  { id: "bogor", label: "Bogor", lat: -6.5950, lng: 106.8166 },
